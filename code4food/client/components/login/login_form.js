    ...
    render () {
        ...
        if (rememberMe) {
            const rememberMeLabel = (
                <FormattedMessage id="Remember me" defaultMessage="Se souvenir de moi" />
            );
        ...
        const username = usernameType === 'email' ? (
                <FormattedMessage id="Email" defaultMessage="Username" />
            ) : (
        ...
        const login = <FormattedMessage id="Log In" defaultMessage="Sign in" />;
        ...
        return (
            <Form className={classes} pad="medium" onSubmit={this._onSubmit}>
                ...
                <Footer size="small" direction="column"
                    ...
                    {rememberMeNode}
                    <Button className="login-button" primary={true} fill={center}
