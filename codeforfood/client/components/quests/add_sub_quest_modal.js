...
export default class AddSubQuestModal extends Component {
    constructor (props) {
        super(props);
        ...
        console.log("questId", this.props.questId);
        this.state = {
            ...
            >
                <Box pad={{vertical: 'large', horizontal: 'small'}}>
                    <Form onSubmit={this._onSubmit}>
                        <header><h1>Add a Sub Quest</h1></header>
                        <FormFields>
                            <fieldset>
                                <FormField label="Name"
                                >
                                    <input name="name" type="text" placeholder="Sub Quest Name"
                        ...
                        <Footer pad={{vertical: 'medium'}} justify='center'>
                            <Button label="Create this Sub Quest slave" primary={true}
